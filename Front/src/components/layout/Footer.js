    ...
    return (
        <footer
            className={`mt-auto border-t border-gray-200 ${
                navigation.pathname === "/login" || navigation.pathname === "/signup" || navigation.pathname === '/profile' || navigation.pathname === "/order" || navigation.pathname === "/register" || navigation.pathname === "/rating"
                    ? "hidden"
                    : "block"
            }`}
        >
